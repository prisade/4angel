...
import {api} from 'api';
  ...
  export const getProducts = createAsyncThunk(
    ...
    async ({ body,token }, thunkAPI) => {
      try {
        const response = await  api.post(`ecommerce/`,'getAllProducts',body,token);
...
export const { ADD_STATE,UPDATE_STATE,FETCH_STATE,REMOVE_STATE,assignState} = ProductsSlice.actions;
