...
const SampleComponentSlice = createSlice({
  name: 'sample1',
...
export const { ADD_STATE, UPDATE_STATE, FETCH_STATE,REMOVE_STATE} = SampleComponentSlice.actions;
export default SampleComponentSlice.reducer;
